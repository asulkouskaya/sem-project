...
public class SmartCalculator {
    ...
    private static boolean isParenthesesLocationCorrect(String tested) {
    ...
    private static boolean isOperatorsAreSingle(String tested) {
        Pattern doubleOperator = Pattern.compile("[/*\\-+^]{2}");
        Matcher matcher = doubleOperator.matcher(tested);
        return !matcher.find();
    }

    private static boolean isNumberOfOperatorsCorrect(String tested) {
